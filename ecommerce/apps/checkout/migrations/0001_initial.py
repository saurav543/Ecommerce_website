    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The  price must be between 0 to 999'}}, help_text='maximum 999.99', max_digits=5, verbose_name='delivery price')),
                ('delivery_method', models.CharField(choices=[('DD', 'Digital Delivery'), ('HD', ' Home delivery'), ('IS', 'In store')], help_text='Required', max_length=255, verbose_name='delivery_method')),
